...
public class HomeActivity extends AppCompatActivity
    ...
    private void setUpMap(Bundle savedInstanceState) {
        ...
        mapView = findViewById(R.id.homeMap);
    ...
    private void setUpUI() {
        ...
        findViewById(R.id.homeWhereTo).setOnClickListener(this);
...
//                .image(BitmapDescriptorFactory.fromResource(R.drawable.location_ground))
//                .position(location, 100f, 100f);
       // myGoogleMap.addGroundOverlay(newarkMap);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.homeWhereTo:{
                Intent intent=new Intent(HomeActivity.this,ActivityRoute.class);
                Bundle bundle=new Bundle();
                bundle.putDouble(sBase.LATITUDE,myLocation.getLatitude());
                bundle.putDouble(sBase.LONGITUDE,myLocation.getLongitude());
                bundle.putString(sBase.ADDRESS,myLocationMarker.getSnippet());
